...
<html>
    ...
    <body>
        ...
        <h1><s:property value="#session.admin.nombre"></s:property></h1>
        <h2><s:text name="pistas"></s:text></h2>
        ...
        <h2><s:text name="competiciones"></s:text></h2>
        ...
        <h2><s:text name="clasificacion"></s:text></h2>
